...
-- CreateEnum
CREATE TYPE "Status" AS ENUM ('UNASSIGNED', 'INPROGRESS', 'TESTING', 'TODO', 'CLOSED');
...
-- AddForeignKey
ALTER TABLE "Bug" ADD CONSTRAINT "Bug_reportingUserId_fkey" FOREIGN KEY ("reportingUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

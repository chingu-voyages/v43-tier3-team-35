            ...
            {data.bugs.length > 0 ? (
              ...
              <div className="mt-6 flex h-[80%] flex-col items-center justify-center rounded-2xl bg-slate-800 text-center">
                ...
                <p className="max-w-md text-sm text-white text-opacity-70">
                  ...
                  moment. Keep up the good work, and don&apos;t hesitate to
                  adjust the filters or report any new bugs that may arise.
                </p>
              </div>
            )}
          </div>
          <div className="">
            ...
            <SidebarCard title="Bug Priority" className="space-y-1">
              {Priorities.map(({ value, background }) => (
                <PriorityButton
                  count={
                    data.bugs.filter((bug) => bug.priority === value).length
                  }
...
export function AssignBugsToDev({
  children,
  developer,
}: {
  children: ReactNode;
  ...
  return (
    ...
    >
      <g opacity="0.5">
        ...
        />
        <path
          d="M26.6726 131.048L12.6758 108.921L73.86 98.4561L78.0621 119.659L84.2739 100.131L115.576 106.312L109.212 131.048H26.6726V131.048Z"
          className="fill-sky-300"
        />
        <path
        ...
        <rect
          ...
          width="9.18575"
          height="20.7872"
          transform="rotate(-7.88 100.742 64.484)"
          fill="white"
        />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M103.285 85.4945C103.374 85.558 103.48 85.5934 103.589 85.596L103.65 85.5859L112.785 84.3273C113.062 84.2905 113.258 84.0363 113.222 83.7589L110.369 63.1645C110.354 63.0302 110.285 62.9077 110.178 62.8254C110.071 62.7431 109.935 62.7079 109.801 62.7281L100.666 63.9867C100.534 64.0073 100.415 64.076 100.331 64.1795C100.251 64.2873 100.218 64.4227 100.24 64.5551L103.092 85.1596C103.103 85.2943 103.174 85.4169 103.285 85.4945ZM104.026 84.51L101.316 64.9205L109.436 63.804L112.146 83.3935L104.026 84.51Z"
          fill="#3A4374"
        />
        <rect
          x="105.568"
        ...
        <path
          ...
          fill="#3A4374"
        />
        <circle cx="104.564" cy="58.6071" r="19.8128" fill="white" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M84.2652 59.3276C84.6425 70.26 93.6144 78.9275 104.553 78.9274C105.487 78.9285 106.42 78.8641 107.345 78.7346C118.18 77.2303 125.874 67.4113 124.745 56.5308C123.615 45.6503 114.067 37.6217 103.154 38.3757C92.241 39.1297 83.8879 48.3951 84.2652 59.3276ZM101.864 39.5251C102.755 39.404 103.654 39.343 104.553 39.3424C114.942 39.3646 123.446 47.6114 123.787 57.9941C124.128 68.3768 116.184 77.164 105.819 77.868C95.4547 78.572 86.3951 70.9398 85.329 60.6063C84.263 50.2728 91.5738 40.9518 101.864 39.5251Z"
          fill="#3A4374"
        />
        <path
          d="M127.858 113.59C126.518 111.888 124.82 110.502 122.885 109.53C117.069 106.485 110.4 106.586 104.28 108.515C102.108 109.205 97.8953 110.189 97.672 113.072C97.6886 114.253 98.476 115.283 99.6107 115.61C100.721 115.898 101.881 115.943 103.011 115.741C101.401 115.698 99.8105 116.098 98.413 116.899C97.1036 117.822 96.383 119.842 97.4589 121.07C97.9344 121.581 98.5538 121.935 99.2351 122.085C100.716 122.493 102.282 122.471 103.752 122.024C102.162 122.329 100.612 122.816 99.1336 123.476C98.2404 123.872 97.2457 124.572 97.3472 125.506C97.4487 126.44 98.3622 126.866 99.1945 127.15C100.946 127.751 102.775 128.093 104.625 128.165C103.028 128.455 101.518 129.104 100.21 130.063C98.1795 131.768 98.1795 135.006 100.93 135.93C101.813 136.188 102.732 136.294 103.65 136.244C111.77 136.244 121.494 135.229 126.995 128.47C129.703 125.306 130.675 121.011 129.594 116.99C129.218 115.764 128.63 114.613 127.858 113.59Z"
          fill="white"
        />
        <path
          fillRule="evenodd"
        ...
        />
        <path
          d="M71.2618 58.9929C71.2618 58.9929 83.6245 77.5674 76.1439 77.8313C68.6634 78.0952 68.0239 76.1363 68.0239 76.1363"
          fill="white"
        />
        <path
          d="M74.804 78.42C68.5313 78.42 67.6279 76.7047 67.5061 76.39C67.4185 76.1129 67.5668 75.8162 67.8411 75.7201C68.1155 75.6331 68.4091 75.7821 68.5008 76.0551V76.0551C68.5008 76.0551 69.4143 77.6283 76.1235 77.3847C76.7911 77.4463 77.4334 77.1132 77.7678 76.5321C79.3715 73.4161 73.3018 63.0834 70.8252 59.3685C70.6873 59.1285 70.7583 58.8228 70.9878 58.668C71.2172 58.5133 71.5272 58.562 71.6981 58.7798C72.642 60.2008 80.8331 72.7868 78.7016 77.0498C78.204 77.9777 77.2156 78.5352 76.1641 78.4809L74.804 78.42Z"
          fill="#3A4374"
        />
        <ellipse
          cx="105.69"
